 ...
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * | Home | Shift|   Z  |   X  |   C  |   V  |   B  |      |   N  |   M  |   ,  |   .  |   /  | Home | End  |
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * | End  |Adjust| Ctrl | Alt  | GUI  |Lower |Space |      |Space |Raise | Left | Down |  Up  | Right|   \  |
 * `------------------------------------------------'      `------------------------------------------------'
 */
  [_QWERTY] = KC_KEYMAP(
  //,----+----+----+----+----+----+----.    ,----+----+----+----+----+----+----.
  ...
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     END ,LCTL,LALT,LGUI, UP ,CMDS,BSPC,     SPC ,RASE,    ,    ,LEFT,DOWN,RGHT
  //`----+----+----+----+----+----+----'    `----+----+----+----+----+----+----'
  ),
 ...
 */
  ...
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     HOME,LSFT, Z  , X  , C  , V  , B  ,      N  , M  ,COMM,DOT ,SLSH,UP  ,BSLS,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     END ,LCTL,LALT,LGUI, UP ,CMDS,SPC ,     BSPC,QWER,    ,    ,LEFT,DOWN,RGHT
  //`----+----+----+----+----+----+----'    `----+----+----+----+----+----+----'
  ),
